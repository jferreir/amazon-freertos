...
#define CONSOLE_IO_UART_TX_PIN P1_15
#define CONSOLE_IO_UART_TX_PIN_AF P1_15_AF_U1C0_DOUT0
#define CONSOLE_IO_UART_RX_PIN P0_5
#define CONSOLE_IO_UART_INPUT USIC1_C0_DX0_P0_5
